...
export const makeFindWorkoutByIdAndUserIdUsecaseFactory = (): FindWorkoutByIdAndUserIdUsecase => {
  ...
  return new FindWorkoutByIdAndUserIdUsecase(workoutRepository, exerciseRepository)
}
